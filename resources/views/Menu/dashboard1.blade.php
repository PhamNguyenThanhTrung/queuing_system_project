            ...
            <div class="container mt-4">
                ...
                <div class="mt-3">
                    ...
                    <div class="khung_bieudo_loc">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <p style="font-weight: 600; font-size: larger; margin-top: 5px; color: black; text-align: left;">Bảng thống kê theo ngày</p>
                                <p style="line-height: 0px; color: #848387; font-size: 18px;">Tháng 11/2021</p>
                            </div>

                            <div class="col-lg-6">
                                <p style="font-weight: 600; font-size: larger; margin-top: 5px; color: black; text-align: right;">Xem theo
                                    <span class="dropdown-icon_capso">
                                        <select name="thoigian" class="dropd_capso" style="color: #757575;">
            ...
            <div class="container" style="margin-top: 90px; height: 660px;">
                <div class="mt-3" style="height: 660px;">
                    ...
                    <!-- Thiết bị -->
                            ...
                            <p style="display: flex; margin-top: 20px; align-items: center;">
                            <input type="date" class="chonthoigian" name="thoigian_dau" id="thoigian_dau" onblur="filterData()" value="{{ request()->thoigian_dau }}">
<span style="font-size: 16px; margin: 0px 10px;"><i class="fa-solid fa-caret-right"></i></span>
<input type="date" class="chonthoigian" name="thoigian_cuoi" id="thoigian_cuoi" onblur="filterData()" value="{{ request()->thoigian_cuoi }}">
                            </p>
                            ...
                            <div class="calendar">
                                ...
                                <ul class="days" id="calendar-days">
                                    @foreach($days as $day)
                                        <li class="{{ $day['class'] }}"><span>{{ $day['day'] }}</span></li>
                                    @endforeach
                                </ul>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        new Morris.Donut({
            ...
            data: [
                {label: deviceCount_hoatdong_pt + '%', value: deviceCount_hoatdong_pt},
                {label: deviceCount_ngunghoatdong_pt + '%', value: deviceCount_ngunghoatdong_pt},
            ],
        ...
        new Morris.Donut({
            ...
            data: [
                {label: serviceCount_hoatdong_pt + '%', value: serviceCount_hoatdong_pt},
                {label: serviceCount_ngunghoatdong_pt + '%', value: serviceCount_ngunghoatdong_pt},
            ],
            formatter: function (y) {
                return '';
            },
        ...
        new Morris.Donut({
            ...
            data: [
                {label: numberCount_dasudung_pt + '%', value: numberCount_dasudung_pt},
                {label: numberCount_dangcho_pt + '%', value: numberCount_dangcho_pt},
                {label: numberCount_boqua_pt + '%', value: numberCount_boqua_pt},
            ],
            formatter: function (y) {
                return '';
            },
