                    ...
                    <div class="khung_dichvu">
                        <div class="container">
                            <p style="padding-top: 20px; font-size: 25px; font-weight: 500; color: orangered;">Thông tin vai
                                trò</p>
                            <div class="row">
                                <form method="POST" action="{{ route('Themthietbi.ThemVT') }}">
                                    @csrf
                                    ...
                                    <div style="display:flex;">
                                        <div class="col-lg-6">
                                            <div class="col-lg-12">
                                                ...
                                                <p>Tên vai trò: <span class="text-danger">*</span>
                                                    <span class="dropdown-loai">
                                                        <input name="Name_VT" class="select_loai">
                                            ...
                                            @if ($errors->has('Name_VT'))
                                            <p class="text-danger">{{ $errors->first('Name_VT') }}</p>
                                        @endif
                                            <div class="col-lg-12">
                                                <!-- Input mô tả -->
                                                <p>
                                                    <label for="source">Mô tả:</label>
                                                    <input type="text" class="nhap_themdichvu" name="source"
                                                        placeholder="Nhập mô tả" style="color: #848387;">
                                                </p>
