...
@section('header')
    ...
    @if ($user = session('user'))
            ...
            <form action="" style="width: 800px; height: 750px; background-color: #f7f7f7;">
                ...
                <div class="container mt-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <p
                                style="width: 1200px; font-weight: 600;
                        font-size: larger; margin-top: 5px; color: orangered;">
                                Dashboard</p>
                        </div>
                    </div>
                        ...
                        <div style="width: 785px; display: flex; justify-content: space-evenly;">
                            ...
                            <div class="khung_bieudo">
                                <div style="display: flex; height: 60px;">
                                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none"
                                        ...
                                        <circle opacity="0.15" cx="24" cy="24" r="23.5" fill="#6695FB"
                                            stroke="#DADADA" />
                            ...
                            <div class="khung_bieudo">
                                <div style="display: flex; height: 60px;">
                                    <svg width="49" height="48" viewBox="0 0 49 48" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <circle opacity="0.15" cx="24.75" cy="24" r="23" fill="#35C75A"
                                            stroke="#35C75A" stroke-width="2" />
                            ...
                            <div class="khung_bieudo">
                                <div style="display: flex; height: 60px;">
                                    <svg width="49" height="48" viewBox="0 0 49 48" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <circle opacity="0.15" cx="24.25" cy="24" r="23.5" fill="#FFAC6A"
                                            stroke="#DADADA" />
                                        <path
                            ...
                            <div class="khung_bieudo">
                                <div style="display: flex; height: 60px;">
                                    <svg width="49" height="48" viewBox="0 0 49 48" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <circle opacity="0.15" cx="24.5" cy="24" r="23.5" fill="#F86D6D"
                                            stroke="#DADADA" />
                                        <path
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <p style="line-height: 0px; color: #848387; font-size: 18px;">Tháng
                                            <?php echo date('m'); ?>/<?php echo date('Y'); ?></p>
                                    </div>
                                        ...
                                        <form action="{{ url('') }}dashboard" id="filterForm" method="get">
                                            <span class="dropdown-icon_capso">
                                                <select id="filterDate" name="filterDate" class="dropd_capso"
                                                    ...
                                                    <option value="Ngày"
                                                        {{ request()->input('filterDate') == 'Ngày' ? 'selected' : '' }}>
                                                        Ngày
                                                    </option>
                                                    <option value="Tháng"
                                                        {{ request()->input('filterDate') == 'Tháng' ? 'selected' : '' }}>
                                                        Tháng
                                                    </option>
                                                    <option value="Năm"
                        ...
                        <div class="content-right" style="height: 615px;">
                            ...
                            <div class="overview-rect">
                                ...
                                <div class="overview-number">
                                    ...
                                    <p class="text-service"><svg width="16" height="15" viewBox="0 0 16 15"
                            ...
                            <div class="overview-rect">
                                ...
                                <div class="overview-number">
                                    ...
                                    <p class="text-numberlevel"><svg width="14" height="14" viewBox="0 0 14 14"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_201_18602)">
                                                <g clip-path="url(#clip1_201_18602)">
                                                    <path d="M1.16663 9.91699L6.99996 12.8337L12.8333 9.91699"
                            ...
                            <div class="calendar" style="height: 320px;">
                                <div class="header-calendar">
                                    ...
                                    <div class="month">
                                        <p><span class="day"></span> <span class="month-name"></span> <span
                                                class="year"></span>
                                        </p>
                                    </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                function filterData() {
                    var fromDate = document.getElementById('thoigian_dau').value;
                    var toDate = document.getElementById('thoigian_cuoi').value;

                    // Apply date filtering
                    filteredData = data.filter(function(item) {
                        var itemDate = new Date(item.y);
                ...
                // Automatically apply initial filtering on page load
                filterData();
            });
        </script>
        ...
        <script>
            ...
            // Get the date, month, and year elements
            ...
            function updateCalendar() {
                // Clear the old days from the list
                daysList.innerHTML = '';

                // Set the new date, month, and year for the calendar
                ...
                // Create elements for the days in the previous month
                for (let i = firstDayOfMonth - 1; i >= 0; i--) {
                    const li = document.createElement('li');
                    const dayNumber = new Date(currentYear, currentMonth, 0).getDate() - i;
                    li.innerHTML = '<span class="oldmonths">' + dayNumber + '</span>';
                    daysList.appendChild(li);
                }

                // Create elements for the days in the current month
                ...
                // Create elements for the days in the next month
                ...
                // Hide the extra days (30th and 31st) if they are not part of the current month
                const extraDays = daysList.querySelectorAll('.oldmonths');
    ...
    data: {
        labels: labels,
        datasets: [{
            label: 'Số lượng cấp số được cấp',
            data: counts,
            ...
            fill: {
                target: 'origin',
                above: gradientFill(ctx, '#4277ff', '#d7e3ff'),
            },
            pointRadius: 2,
            pointStyle: 'dash',
        }],
